...
export default function PortfolioMenu() {
  return (
    <div className="fixed left-0 top-0 h-screen w-80 bg-white shadow-lg z-50 flex flex-col justify-between p-8">
      {/* Main Navigation */}
          ...
          {menuItems.map((item, index) => (
            <li key={index} className="group">
              ...
              >
                ...
                <span className="text-blue-500 text-lg font-bold ml-4 opacity-70">
